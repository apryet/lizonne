...
tpl_files = mopt.collect_pest_files('tpl')
par_files = mopt.collect_pest_files('par') 
...
dvpars = par.index[par.index.str.contains('fac')]
...
#  decision variables
pst.pestpp_options['opt_dec_var_groups'] = ['aqpump','rivpump']
